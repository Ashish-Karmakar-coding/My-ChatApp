...
export default function SignUpPage() {
  ...
  return (
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)] px-4 py-12 relative overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-1/4 left-1/4 size-64 bg-cyan-500/10 blur-[100px] rounded-full" />
      <div className="absolute bottom-1/4 right-1/4 size-64 bg-purple-500/10 blur-[100px] rounded-full" />
      ...
      <div className="w-full max-w-md glass-card p-8 sm:p-12 relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 mt-2 font-medium">Join the aurora conversation</p>
        </div>
        ...
        <p className="text-center mt-10 text-slate-400 text-sm font-medium">
          ...
          <Link
            to="/login"
            className="text-cyan-400 hover:text-cyan-300 font-black tracking-wider transition-colors"
          >
            SIGN IN
          </Link>
        </p>
